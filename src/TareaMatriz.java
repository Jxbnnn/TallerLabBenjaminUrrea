    ...
    public static void main(String[] args) {
        ...
        while (continuar) {
            ...
            if (validarOpcion(opcion)) {
                switch (opcion) {
                    case 1: matriz = crearMatriz(scanner); break;
                    case 2: mostrarFila(matriz, scanner); break;
                    case 3: verificarMatrizCero(matriz); break;
                    case 4: continuar = false; System.out.println("Saliendo del programa."); break;
